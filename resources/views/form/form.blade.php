...
@section('main')
    ...
    <form method="POST" action="{{ route('enviar') }}">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <label for="card_number" >NÚMERO DO CARTAO:</label><br>
            <input type="text" id="card_number" name="card_number"
                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                   value="{{ old('card_number') }}"><br>

            <label for="validate">VALIDADE:</label><br>
            <input type="text" id="validate" name="validate" value="{{ old('validate') }}"><br>

            <label for="cvc">CVC:</label><br>
            <input type="text" id="cvc" name="cvc" value="{{ old('cvc') }}"><br><br>
